...
ax.set_ylabel('Log Play Count', fontsize=15)
ax.set_title('Log Play Count Distribution by Gender', fontsize=15)
plt.xticks(fontsize=15)
plt.yticks(fontsize=15)
plt.savefig("gender_by_popularity2.png")
plt.show()
...
ax1.set_title('Male/Female Split in Different Genres', fontsize=20)
...
ax2.set_title('Male/Female Split in Different Genres (Balanced Dataset)', fontsize=20)
